...
export default {
  ...
  data() {
    return {
      ...
      chartOptionss: {
        ...
        labels: ["Amount of Paid course", "Amount of Free course"],
        dataLabels: {
          enabled: true
        },
        responsive: [
  ...
  methods: {
    handleListYear() {
      this.$store.dispatch("adminGetStatistical").then(response => {
    ...
    handleCourseStatistical() {
      this.$store.dispatch("adminGetInfoCourseStatistical").then(response => {
    ...
    handleListDataInfo() {
      ...
      this.$store.dispatch("adminGetInfoStatistical", object).then(response => {
        if (response.data.errorToken === true) {
          commonService.checkErrorToken(this, response.data.msg);
        } else {
          if (response.data.RequestSuccess === true) {
